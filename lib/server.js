...
const BROWSER_DEBUGGING_HOST = process.env.BROWSER_DEBUGGING_PORT || '127.0.0.1';
...
server.init = function(options) {
	...
	this.options.browserDebuggingHost = this.options.browserDebuggingHost || BROWSER_DEBUGGING_PORT;
